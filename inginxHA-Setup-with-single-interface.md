...
<b>I have done this configuration on 2 nodes with one virtual ip and drbd shared volume where all the nginx configuration will be stored. This configuration is done on vmware environment.</b>
